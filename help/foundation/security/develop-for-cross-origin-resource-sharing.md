...
* SimpleHTTPServer (wrapper de [[!DNL Python]&#39;s SimpleHTTPServer](https://docs.python.org/2/library/simplehttpserver.html)) diffuse la page HTML via le port 8000.
   * _Plus disponible dans la boutique d’applications Mac. Utilisez des méthodes similaires telles que [Jeeves](https://apps.apple.com/us/app/jeeves-local-http-server/id980824182?mt=12)._
