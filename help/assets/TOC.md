...
+ Configuration{#configuring}
   ...
   + [Workflows de démarrage automatique](configuring/auto-start-workflows.md)

+ Création{#authoring}
   + [Changement de vue](./authoring/switch-views.md)
...
+ Recherche et détection{#search-and-discovery}
   ...
   + [Amélioration de la recherche](./search-and-discovery/search-boost.md)
...
+ Fonctionnalités avancées{#advanced}
   ...
   + [Extraction d’une archive](./advanced/extract-archive.md)
   ...
   + [Sous-titres vidéo fermés](./advanced/video-closed-captions.md)
...
+ Adobe Asset Link{#adobe-asset-link}
   ...
   + [Lié](./adobe-asset-link/place-linked.md)
...
+ Dynamic Media{#dynamic-media}
   ...
   + Tutoriels {#tutorials}
      ...
      + [Création de visionneuses d’images](dynamic-media/tutorials/creating-different-kinds-of-sets-with-aem-dynamic-media-image-sets.md)
      ...
      + [Déclenchement d&#39;une tâche d&#39;export](dynamic-media/tutorials/how-to-trigger-export-job-in-dynamic-media-during-submit-job-operation-parameter.md)
