---
title: Listes de lecture vidéo de la vue d’administration d’AEM Assets
description: Découvrez comment tirer parti des fonctionnalités d’administration d’AEM Assets as a Cloud Service avec cette collection de listes de lecture vidéo conçue pour améliorer vos compétences sur ces produits.
...
# Listes de lecture vidéo pour la vue d’administration
...
## Configurer la vue d’administration
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Découvrez comment les utilisateurs et utilisatrices s’authentifient à l’aide d’Adobe IMS pour AEM as a Cloud Service et comment les utilisateurs et utilisatrices, groupes d’utilisateurs et d’utilisatrices et profils de produits Adobe IMS sont utilisés pour contrôler l’accès à AEM et à ses fonctionnalités.</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Configure AEM Assets">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/fr/playlists/experience-manager-assets-configure-administrators" target="_blank" rel="referrer" title="Configurer AEM Assets">Configurer AEM Assets</a>
                    </p>
...
## Commencer avec la vue d’administration

Naviguez dans l’interface d’administration de manière professionnelle : découvrez les outils et les techniques permettant de gérer efficacement les ressources.
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Get Started with AEM Assets Admin View for Business Users">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/fr/playlists/experience-manager-assets-get-started-business-users" target="_blank" rel="referrer" title="Commencer avec la vue d’administration AEM Assets pour les utilisateurs et utilisatrices professionnels">Commencer avec la vue d’administration AEM Assets pour les utilisateurs et utilisatrices professionnels</a>
                    </p>
                    <p class="is-size-6">Découvrez les principes de base de la vue d’administration AEM Assets, notamment la navigation, l’organisation et la modélisation des ressources, ainsi que les opérations de base telles que la création, la mise à jour et la suppression.</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Understand Asset Metadata in AEM Assets">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/fr/playlists/experience-manager-assets-understand-metadata" target="_blank" rel="referrer" title="Comprendre les métadonnées de ressources dans AEM Assets">Comprendre les métadonnées de ressources dans AEM Assets</a>
                    </p>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Optimize Search in AEM Assets">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/fr/playlists/experience-manager-assets-optimize-search" target="_blank" rel="referrer" title="Optimiser la recherche dans AEM Assets">Optimiser la recherche dans AEM Assets</a>
                    </p>
                    <p class="is-size-6">Découvrir comment optimiser l’expérience de recherche dans AEM Assets</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Use Smart Tags to Enhance Asset Discovery">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/fr/playlists/experience-manager-assets-use-smart-tags" target="_blank" rel="referrer" title="Utiliser les balises intelligentes pour améliorer la découverte de ressources">Utiliser les balises intelligentes pour améliorer la découverte de ressources</a>
                    </p>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Create Custom Renditions with AEM Content Automation">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/fr/playlists/experience-manager-assets-create-renditions-content-automation" target="_blank" rel="referrer" title="Créer des rendus personnalisés avec l’automatisation de contenu AEM">Créer des rendus personnalisés avec l’automatisation de contenu AEM</a>
                    </p>
                    <p class="is-size-6">Découvrez comment utiliser le module complémentaire d’automatisation du contenu qui intègre Adobe Experience Manager Assets as a Cloud Service aux API du service Adobe Creative Cloud pour traiter vos ressources.</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Use Creative Operations with AEM Assets Content Automation">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/fr/playlists/experience-manager-assets-use-creative-operations-with-content-automation" target="_blank" rel="referrer" title="Utiliser les opérations de création avec l’automatisation du contenu AEM Assets">Utiliser les opérations de création avec l’automatisation du contenu AEM Assets</a>
                    </p>
                    <p class="is-size-6">Découvrez comment utiliser le module complémentaire d’automatisation du contenu pour effectuer des opérations Creative Cloud sur Adobe Experience Manager Assets.</p>
                </div>
