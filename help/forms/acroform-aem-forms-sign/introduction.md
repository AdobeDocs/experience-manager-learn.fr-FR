...
description: Tutoriel qui décrit la création d’un formulaire adaptatif à l’aide d’Acrobat et la fusion des données pour obtenir un PDF. Le fichier PDF contenant les données fusionnées peut ensuite être envoyé pour signature à l’aide d’Adobe Sign.
