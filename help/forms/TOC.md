...
+ Sélection et assemblage du contenu du dossier DAM{#select-dam-folder-content}
   ...
   + [Assemblage de ressources sélectionnées](display-and-assemble-dam-folder-contents/assemble-selected-newsletters.md)
...
+ AEM Forms et Acrobat Sign{#forms-and-sign}
   ...
   + [Création d’une application API Acrobat Sign](aem-forms-and-adobe-sign/create-adobe-sign-api-application.md)
   + [Création d’une configuration Acrobat Sign Cloud](aem-forms-and-adobe-sign/create-adobe-sign-cloud-configuration.md)
...
+ Signature de plusieurs Forms{#sign-multiple-documents}
   ...
   + [Workflow de mise à jour de l’état des signatures](sign-multiple-documents/update-signature-status.md)
   + [Personnalisation du composant de résumé](sign-multiple-documents/customize-summary-component.md)
...
+ Étapes de workflow personnalisées{#custom-workflow-steps}
   + [Extraction de noeud du document xml](custom-workflow-steps/extract-xml-node.md)
   + [Enregistrer le document dans le système de fichiers](custom-workflow-steps/write-payload-document.md)
   + [Enregistrement des données envoyées dans la variable string](custom-workflow-steps/save-submitted-data-in-string-variable.md)
+ Composant de workflow personnalisé{#custom-workflow-component}
   + [Présentation](custom-workflow-component/introduction.md)
   + [Ecrire du code Java](custom-workflow-component/custom-process-step-aem-workflow.md)
   + [Création d’un composant de workflow](custom-workflow-component/custom-workflow-component.md)
