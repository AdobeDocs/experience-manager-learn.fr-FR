...
seo-description: À compter d’AEM Forms 6.4, nous avons désormais la possibilité de définir le modèle de données de formulaire (FDM) sans l’associer à une source de données. La vidéo suivante décrit les étapes à suivre pour créer FDM sans source de données.
feature: Workflow
topics: integrations
audience: developer
