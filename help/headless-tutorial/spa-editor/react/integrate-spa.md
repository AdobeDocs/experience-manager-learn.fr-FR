...
Félicitations, vous avez mis à jour le SPA et exploré l&#39;intégration avec AEM ! Vous savez maintenant comment développer la SPA par rapport à l’API de modèle JSON AEM à l’aide d’une **webpack-dev-server**.
