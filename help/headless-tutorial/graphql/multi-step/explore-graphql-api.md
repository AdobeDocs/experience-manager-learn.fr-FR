...
Pour d&#39;autres exemples de requêtes GraphQL, voir : [Apprendre à utiliser GraphQL avec AEM - Exemple de contenu et de Requêtes](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/content-fragments-graphql-samples.html?lang=fr).
