---
title: Résolution des chemins d’image pour AEM GraphQL
description: null
...
# Chemins d’accès des images pour AEM GraphQL
...
## Exigences relatives aux chemins


| Client | Partage du domaine avec AEM | Domaine distinct de l’AEM | Aucun domaine (ex. Mobile, côté serveur) |
|----------------------------:|:-----------------------:|:------------------------:|:-----------------------------------:|
| Nécessite un chemin d’accès à la ressource | ✘ | ✔ | ✔ |

## Utilisation de l’hôte AEM
