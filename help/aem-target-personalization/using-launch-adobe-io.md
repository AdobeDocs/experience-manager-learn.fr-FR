---
title: Intégration de Adobe Experience Manager avec Adobe Target à l'aide des E/S Experience Platform Launch et Adobe
seo-title: Intégration de Adobe Experience Manager avec Adobe Target à l'aide des E/S Experience Platform Launch et Adobe
description: Procédure pas à pas pour intégrer Adobe Experience Manager à Adobe Target en utilisant les E/S Experience Platform Launch et Adobe
seo-description: Procédure pas à pas pour intégrer Adobe Experience Manager à Adobe Target en utilisant les E/S Experience Platform Launch et Adobe
...
# Utilisation de Adobe Experience Platform Launch via la console d&#39;E/S Adobe

## Conditions préalables

* [aem instance](./implementation.md#set-up-aem) d’auteur et de publication s’exécutant sur les ports localhost 4502 et 4503, respectivement
* **Experience Cloud**
...
3. Dans le sélecteur de solution, cliquez sur **Lancer** , puis sélectionnez le bouton **Atteindre le lancement** .
...
4. Assurez-vous que vous êtes dans la bonne organisation, puis continuez à créer une propriété Launch.
   ...
   *Pour plus d’informations sur la création de propriétés, voir[Création d’une propriété](https://docs.adobelaunch.com/administration/companies-and-properties#create-a-property)dans la documentation du produit.*
...
7. En tant que domaine, entrez *localhost.com* car il s’agit du domaine sur lequel le site de démonstration WKND est exécuté. Bien que le champ &quot;*Domaine*&quot; soit obligatoire, la propriété Launch fonctionne sur n’importe quel domaine dans lequel elle est implémentée. Ce champ a pour Principal de prérenseigner les options de menu dans le créateur de règles.
...
1. Sous **Extensions**, vous pouvez voir la liste des extensions déjà installées pour votre propriété Launch. ([Experience Platform Launch Core Extension](https://exchange.adobe.com/experiencecloud.details.100223.adobe-launch-core-extension.html) est installé par défaut)
2. Cliquez sur l’option Catalogue des **extensions** et recherchez la Cible dans le filtre.
...
1. Cliquez sur l&#39;onglet **Environnement** de la propriété de votre site et vous pouvez voir la liste d&#39;environnement qui est créée pour la propriété de votre site. Par défaut, une instance est créée pour le développement, l’évaluation et la production.

![Elément de données - Nom de page](assets/using-launch-adobe-io/launch-environment-setup.png)

#### Création et publication

1. Cliquez sur l’onglet **Publication** de la propriété de votre site, puis créez une bibliothèque pour créer et déployer nos modifications (éléments de données, règles) sur un environnement de développement.
...
>[!NOTE]
>
> Accordez à l&#39;intégration d&#39;E/S d&#39;Adobe l&#39;accès à certains espaces de travail avec le [rôle approprié pour permettre à une équipe centrale d&#39;apporter des modifications pilotées par l&#39;API dans quelques espaces de travail](https://docs.adobe.com/content/help/en/target/using/administer/manage-users/enterprise/configure-adobe-io-integration.html)seulement.

1. Créez l&#39;intégration IMS dans AEM à l&#39;aide des informations d&#39;identification de l&#39;E/S Adobe (01:12 à 03:55).
2. Dans Experience Platform Launch, créez une propriété. (couvert [ci-dessus](#create-launch-property))
...
À ce stade, vous avez réussi à intégrer [AEM avec Adobe Target à l’aide de Adobe Experience Platform Launch](./using-aem-cloud-services.md#integrating-aem-target-options) , comme indiqué dans l’option 1.
