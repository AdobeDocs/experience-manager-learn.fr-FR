...
short-description: Tutoriel de développement sur la création de sites web AEM qui associent puissante création à l’éditeur universel et diffusion ultra-rapide à l’aide de Edge Delivery Services. Découvrez comment créer un projet, configurer un environnement de développement local et créer des blocs personnalisés.
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./3-local-development-environment.md" title="Configurer un environnement de développement local" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3443980/?captions=fre_fr&format=jpeg&nocache=1753811862249" alt="Configurer un environnement de développement local"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
