...
Le projet AEM contient l’ensemble du code et des configurations pour une mise en oeuvre. Le [!DNL AEM Project Archetype] crée un projet Adobe Experience Manager minimal basé sur les bonnes pratiques comme point de départ de vos propres projets AEM.
