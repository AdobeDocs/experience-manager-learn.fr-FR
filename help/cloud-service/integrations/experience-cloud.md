...
| [Chargé d’apprentissage](#adobe-learning-manager) | ✔ |  |  |
| Marketo Engage |  |  |  |
| CDP en temps réel |  |  |  |
| [Sensei](#adobe-sensei) | ✔ | ✔ | ✔ |
| [Cible](#adobe-target) | ✔ |  |  |
...
## un résultat Adobe Acrobat Sign
...
+ [Intégrer à Adobe Campaign Classic](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/sites/integrations/integrating-campaign-classic.html#configure-user)
...
+ [Service de conversion automatisée de formulaires](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/configure-service.html)
