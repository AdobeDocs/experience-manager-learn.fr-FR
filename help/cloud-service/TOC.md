...
+ AI {#ai}
   ...
   + Serveurs MCP {#mcp-servers}
      + [Vue d’ensemble](./ai/mcp/overview.md)
      + [Accélérer les opérations de contenu AEM avec le serveur MCP](./ai/mcp/accelerate-content-operations-with-aem-mcp-server.md)
      + [Serveur MCP Cloud Manager](./ai/mcp/cloud-manager.md)
...
+ Développement{#developing}
   ...
   + Avancé{#advanced}
      ...
      + [Recherche et suppression des API obsolètes](./developing/advanced/deprecated-apis-find-removal.md)
...
+ Personnalisation {#personalization}
   ...
   + Cas d’utilisation {#use-cases}
      + [Expérimentation (tests A/B)](./personalization/use-cases/experimentation.md)
      + [Ciblage comportemental](./personalization/use-cases/behavioral-targeting.md)
      + [Personalization d’utilisateurs connus](./personalization/use-cases/known-user-personalization.md)
+ API d’AEM{#aem-apis}
...
+ Authentification{#authentication}
   ...
   + [Hooks de connexion SAML](./authentication/saml-2-0-login-hook.md)
...
+ Sécurité {#security}
   ...
   + Règles de filtrage de trafic incluant des règles WAF {#traffic-filter-and-waf-rules}
      + [Protection des sites web AEM](./security/traffic-filter-and-waf-rules/overview.md)
      + [Méthode de configuration](./security/traffic-filter-and-waf-rules/setup.md)
      + [Utilisation de règles de filtrage de trafic](./security/traffic-filter-and-waf-rules/use-cases/using-traffic-filter-rules.md)
      + [Utilisation de règles WAF](./security/traffic-filter-and-waf-rules/use-cases/using-waf-rules.md)
      + [Bonnes pratiques](./security/traffic-filter-and-waf-rules/best-practices.md)
      + Procédures{#how-to}
         + [Surveillance des requêtes sensibles](./security/traffic-filter-and-waf-rules/how-to/request-logging.md)
         + [Restriction de l’accès](./security/traffic-filter-and-waf-rules/how-to/request-blocking.md)
         + [Normalisation des requêtes](./security/traffic-filter-and-waf-rules/how-to/request-transformation.md)
...
+ Formulaires{#forms}
   ...
   + Tutoriel sur la communication interactive{#interactive-communication-tutorial}
      + [&#x200B;1. Présentation](./forms/interactive-communication-tutorial/introduction.md)
      + [&#x200B;2. Créer FDM](./forms/interactive-communication-tutorial/create-form-data-model.md)
      + [&#x200B;3. Créer un modèle](./forms/interactive-communication-tutorial/create-template.md)
      + [&#x200B;4. Créer des fragments](./forms/interactive-communication-tutorial/create-fragments.md)
      + [&#x200B;5. Créer un document IC](./forms/interactive-communication-tutorial/create-ic-document.md)
      + [&#x200B;6. Générer un document IC](./forms/interactive-communication-tutorial/test-document-generation.md)
