---
title: Utilisation de Cloud Manager avec AEM as a Cloud Service
...
+ [Exercice pratique d’intégration](./onboarding.md#hands-on-exercise)
...
"><img alt="Référentiel GitHub d’exercice pratique" src="./assets/github.png"/>
            </a>        
        </td>
        <td style="width:100%;margin-bottom:1rem;">
            <div style="font-size:1.25rem;font-weight:400;">Utilisation de Cloud Manager</div>
...
" class="spectrum-Button spectrum-Button--primary spectrum-Button--sizeM">
                <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">Essai de Cloud Manager</span>
            </a>
        </td>
    </tr>
</table>
