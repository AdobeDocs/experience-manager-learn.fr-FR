...
>[!VIDEO](https://video.tv.adobe.com/v/3453897?captions=fre_fr&quality=12&learn=on)
...
+ [Exercice pratique : intégration](./onboarding.md#hands-on-exercise)
...
"><img alt="Exercice pratique : référentiel GitHub" src="./assets/github.png"/>
            </a>        
        </td>
        <td style="width:100%;margin-bottom:1rem;">
            <div style="font-size:1.25rem;font-weight:400;">Exercice pratique : Cloud Manager</div>
            <p style="margin:1rem 0">
                Explorez le déclenchement d’un pipeline Cloud Manager à l’aide du plug-in AIO CLI Cloud Manager.
            </p>
            <a  rel="noreferrer"
                target="_blank"
                href="https://github.com/adobe/aem-cloud-engineering-video-series-exercises/tree/session4-cloud-manager#bootcamp-session-4-cloud-manager-develop-and-deploy
" class="spectrum-Button spectrum-Button--primary spectrum-Button--sizeM">
<span class="spectrum-Button-label has-no-wrap has-text-weight-bold">Essayer Cloud Manager</span>
</a>
        </td>
    </tr>
</table>
