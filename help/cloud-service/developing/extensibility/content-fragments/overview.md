...
Une seule extension de la console de fragments de contenu AEM peut inclure zéro ou un menu d’en-tête, ainsi que zéro ou un type d’extension de barre d’actions. Si plusieurs types d’extension du même type sont requis, plusieurs extensions de la console Fragments de contenu AEM doivent être créées.
...
Effectuez une sélection parmi les fonctionnalités suivantes lors de la génération de l’application App Builder, en fonction de ce que l’extension fera. Toutes les combinaisons d’options peuvent être utilisées dans une extension.
...
Suivez les étapes décrites ci-dessous pour découvrir comment générer, développer et déployer une extension AEM Content Fragment Console pour AEM as a Cloud Service.
...
<div class="columns is-multiline">
        ...
        <div class="card">
            <div class="card-image">
                <figure class="image is-16by9">
                    <a href="https://developer.adobe.com/uix/docs/services/aem-cf-console-admin/extension-development/#create-a-project-in-adobe-developer-console" title="Création d’un projet Adobe Developer" tabindex="-1" target="_adobe-developer-com">
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Generate an Extension app">
        <div class="card">
            <div class="card-image">
                <figure class="image is-16by9">
                    <a href="https://developer.adobe.com/uix/docs/services/aem-cf-console-admin/code-generation/#launch-code-generation-during-project-initialization" title="Génération d’une application d’extension" tabindex="-1" target="_adobe-developer-com">
        ...
        <div class="card">
            ...
            <div class="card-content is-padded-small">
                <div class="content">
                    ...
                    <p class="is-size-6">Découvrez comment créer des extensions de menu d’en-tête de la console de fragments de contenu AEM.</p>
        ...
        <div class="card">
            ...
            <div class="card-content is-padded-small">
                <div class="content">
                    ...
                    <p class="is-size-6">Découvrez comment créer des extensions de barre d’actions de la console de fragments de contenu AEM.</p>
        ...
        <div class="card">
            ...
            <div class="card-content is-padded-small">
                <div class="content">
                    ...
                    <p class="is-size-6">Testez les extensions pendant le développement, ainsi que partagez les extensions terminées avec les testeurs AQ ou UAT à l’aide d’une URL spéciale.</p>
